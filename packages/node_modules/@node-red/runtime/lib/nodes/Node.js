...
Node.prototype.setupMQTT = function () {
    ...
    // TODO: temporary
    this.inputTopics = ["mqtt/data"];
    this.outputTopics = ["mqtt/results"];
...
Node.prototype.onReceiveMQTT = function (topic, payload, mpacket) {
    console.log(`[MINE] RECEIVE MQTT message from topic ${topic}: ${payload}`);
 ...
 */
Node.prototype.sendMQTT = function (msg) {
...
/**
 * [MINE]
 * Receive a message from a MQTT topic
 * 
 */
Node.prototype.receiveMQTT = function (msg) {
