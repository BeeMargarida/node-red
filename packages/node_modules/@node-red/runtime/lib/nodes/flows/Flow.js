...
class Flow {
    ...
    constructor(parent, globalFlow, flow) {
        ...
        this.orchestrator = Orchestrator.create(this.context);
    }
    ...
    start(diff, deviceChanges) {
        ...
        this.orchestrator.distributeFlow(this.activeNodes, deviceChanges)
            .then(nodeAssignment => {
                this.context.nodeAssignment = nodeAssignment
            });
        if (Object.keys(this.context.nodes).length > 0) {
            this.context.heartbeatInterval = this.orchestrator.setupHeartbeat();
        }
