    ...
    constructor(parent, globalFlow, flow) {
        ...
        this.context.devices = {
            ...
            "192.168.1.206": {
                ...
                state: {},
                memoryErrorNodes: null,
                capabilities: ["temperature", "humidity", "micropython", "first-floor"],
                nodes: []
            }
        };
    }
...
async def exec(mqtt_c):
    ...
    async distributeFlow(nodes, changes) {
        ...
        for (const id in nodeAssignment) {
            if (this.context.devices[id].status === 0 && nodeAssignment[id].nodes.length > 0) {
    ...
    setupHeartbeat() {
        ...
        if (this.context.heartbeatInterval !== undefined) return;
        this.context.heartbeatInterval = setInterval(() => this.heartbeat(), 10000)
    }
    ...
    start(diff, deviceChanges) {
        ...
        if (Object.keys(this.context.nodes).length > 0) {
            this.setupHeartbeat();
        }
