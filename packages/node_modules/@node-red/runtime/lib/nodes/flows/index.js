...
function setFlows(_config,_credentials,type,muteLog,forceStart) {
    console.log("[MINE] setFlows: ",_config, type, forceStart);
    ...
    if (type === "load") {
        ...
        configSavePromise = loadFlows().then(function(_config) {
            console.log("[MINE] setFlows Load Flows: ", _config);
        ...
        // [MINE] Add input and output topics to node
        ...
        .then(function(flowRevision) {
            ...
            if (forceStart || started) {
                ...
                return stop(type,diff,muteLog).then(() => {
                    ...
                    console.log("[MINE] setFlows DEPLOY!");
...
function start(type,diff,muteLog) {
    console.log("[MINE] Run when started and (deployed - from setFlows()!): ", type, diff);
    type = type||"full";
    started = true;
    var i;
