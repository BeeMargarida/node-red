        ...
        if (this.brokerConn) {
            ...
            if (this.topic) {
                ...
                this.brokerConn.subscribe(this.topic, this.qos, function (topic, payload, packet) {
                    ...
                    node.context().global.get("devices", (err, devicesRes) => {
                        if(err)  return node.error(err, "Can't access devices in the global context.");

                        const ip = payload.address;
                        const capabilities = payload.capabilities;

                        const devices = devicesRes ? devicesRes : {};
                        ...
                        node.context().global.set("devices", devices, (err) => {
                            if(err) node.error(err, "Problem saving device information in the global context.");
                        })
