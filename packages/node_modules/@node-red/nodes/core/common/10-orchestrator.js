    ...
    function OrchestratorNode(n) {
        ...
        this.on("input", async function (msg, done) {
            try {
                ...
                !assigning && await distributeFlow(nodes, null);
                setupPing();
            } catch (err) {
    ...
    return\n`
        ...
        function sendCode(code, address, nrNodes) {
            ...
            return axios({
                ...
                console.log(err);
                node.log(`ERROR in sending code of ${nrNodes} to device ${address}: Status ${err.response ? err.response.status : 500}`);;
                // Send telemetry to orchestrator nodes
            ...
            if (Object.keys(nodeAssignment).length > 0) {
                ...
                fs.writeFile(`python-scripts/node-assignment-${Date.now()}.json`,
                    ...
                    function (err) {
                        ...
                        node.log("The node assignmet file was saved!");
                    });
