...
module.exports = function (RED) {
    ...
    function SwitchNode(n) {
        ...
        let pythonOperators = {
            ...
            'gt': function (a, b) { return "a > b"; },
            'gte': function (a, b) { return "a >= b"; },
            'btwn': function (a, b, c) { return ("a >= b and a <= c") || ("a <= b and a >= c"); },
            // 'cont': function (a, b) { return (a + "").indexOf(b) != -1; },
            // 'regex': function (a, b, c, d) { return (a + "").match(new RegExp(b, d ? 'i' : '')); },
            'true': function (a) { return "a == True"; },
            'false': function (a) { return "a == False"; },
            'null': function (a) { return ("a == None"); },
            'nnull': function (a) { return ("a != None"); },
            // 'empty': function (a) {
            //     if (typeof a === 'string' || Array.isArray(a) || Buffer.isBuffer(a)) {
            //         return a.length === 0;
            //     } else if (typeof a === 'object' && a !== null) {
        ...
        function generateMicropythonCode() {
            // rules: { t -> operator, v -> value to compare to, bt -> type of value}
            // check if msg is <operator> 

            let code = `
                def switch(a,b):
                    
                    return ${pythonOperators[]}
