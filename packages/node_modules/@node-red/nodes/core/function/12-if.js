...
module.exports = function (RED) {
    ...
    function IfNode(n) {
        ...
        // MICROPYTHON CODE
        node.setMicropythonCode(generateMicropythonCode(this.rules))
        ...
        function generateMicropythonCode(rules) {
            ...
            for (let i = 0; i < rules.length; i++) {
                ...
                const ifRules = `def ifRule${i}(a${pythonParameters(valuesRule)}):\n    ${typeConverter(rules[i].vt)}\n    return ${pythonOperators[rules[i].t]}\n`;

                rulesBlock += i == 0 ? `ifRule${i}(a)` : ` and ifRule${i}(a)`;
                ifBlock += ifRules;
            }
