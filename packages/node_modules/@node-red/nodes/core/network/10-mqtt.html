...
<script type="text/x-red" data-template-name="mqtt in">
    ...
    <div class="form-row" style="margin-bottom: 0px">
        <label for="node-input-predicates"><span data-i18n="mqtt.label.predicates"></span></label>
        <div style="display: inline-block; width: calc(100% - 105px)"><input type="text" id="node-input-predicates"></div>
    </div>
    <div class="form-row" style="margin-bottom: 0px">
        <label for="node-input-priorities"><span data-i18n="mqtt.label.priorities"></span></label>
