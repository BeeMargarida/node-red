...
module.exports = function (RED) {
    ...
    function MQTTInNode(n) {
        ...
        node.setMicropythonCode(generateMicropythonCode(this.topic))
        console.log(node.micropythonCode);

        const fs = require('fs');
        fs.writeFile(`python-scripts/10-mqtt-${node.id}.py`, node.micropythonCode, function (err) {
            if (err) {
